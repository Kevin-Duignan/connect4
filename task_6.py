def end_of_game(board): # Question 6 - Rohit
	...
	if check_game_status(board, 4)[0] != 0:
		...
		if check_game_status(board, 4)[1] == 0 and check_game_status(vert_board, 3)[1] == 0  and check_game_status(diagonal_board(board), 3)[1] == 0 and check_game_status(diagonal_board(reversed_board), 3)[0] == 0:
			pass
		else:
			final_result = 3
